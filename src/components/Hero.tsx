...
const Hero = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="absolute inset-x-0 bottom-[200px] text-center text-hatchery py-4">
          
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-glow">
            <span className="text-hatchery-mint text-4xl">HATCHERY</span> <span className="text-hatchery-light">NO.7</span>
          </h1>
